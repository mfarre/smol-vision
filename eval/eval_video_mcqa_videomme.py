...
#python eval_video_mcqa_videomme.py --results_file=/fsx/miquel/qwenexperiments/eval_output/videomme/answers/Qwen/Qwen2-VL-7B-Instruct/300/merge.json --video_duration_type=short,long,medium
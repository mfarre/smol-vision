...
def main():
    ...
    if USE_WANDB and is_main_process_multi_node():
        wandb.init(
            ...
            name="v1-filter-lowlrhighwarmup_4_acum2",
            config={
                "model_id": model_id,
                "use_lora": USE_LORA,
                "use_qlora": USE_QLORA,
    ...
    training_args = TrainingArguments(
        ...
        gradient_accumulation_steps=64//num_nodes,  # Increased from 16 to 32
        ...
        bf16=True,
        output_dir="./smolvlm-longvumix-filter1-lowlrhighwarm_4_acum2",
